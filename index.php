         ...
         <?php include "Includes/categories.php"?>
            ...
            <div class="col-md-8">
                ...
                <?php
                 ...
                 $book_query = "SELECT * FROM book_info ORDER BY RAND () LIMIT 0,8";
                 ...
                 <div class="col-md-3">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                         ...
                         <a class="btn btn-info btn-lg btn-block" book_id="$book_id" id="books"><i class="fa fa-shopping-cart"></i><strong> Add to Cart </strong></a>
                        </div>
                   </div>
                </div>  
                    <?php  }?>   
